...
jQuery(function ($) {
	...
	function scroll(posscroll) {
	    ...
	    /* Para botones de redes sociales flotantes */
	    if (posscroll > 600) {
	    	$('#block-networks').addClass('display-block');
	    } else {
	    	$('#block-networks').removeClass('display-block');$('#block-networks').addClass('display-none');
	    }
	...
	$('a[data-rel*=modal]').click(function () {
	    ...
	    $('#demoviewer img').attr('src', 'i/s' + demo + '.jpg');
	});
